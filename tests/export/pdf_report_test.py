...
from tests.server_calls import auth_register_v2, clear_v2, export_pdf_report_v1, invoice_upload_text_v1
...
def test_pdf_valid_invoice():
    ...
    assert report_bytes
    clear_v2(auth_register_v2("churros@admin.com", "abc123")["token"])
