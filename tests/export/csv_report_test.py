...
# Testing that the report was generated properly and matches input data
def test_csv_extensive_test_valid_invoice():
...
# def test_csv_multiple_violations_same_rule():
#     data = VALID_INVOICE_TEXT
...
# def test_csv_multiple_violations_different_rules():
#     data = VALID_INVOICE_TEXT
...
# def test_csv_invalid_wellformedness():
#     data = VALID_INVOICE_TEXT
