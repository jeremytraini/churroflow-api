...
def test_upload_url_valid_invoice():
    invoice = Invoice(name="My Invoice", data="https://raw.githubusercontent.com/A-NZ-PEPPOL/A-NZ-PEPPOL-BIS-3.0/master/Message%20examples/AU%20Invoice.xml")
    response = invoice_upload_url_v1(invoice.name, invoice.text)
